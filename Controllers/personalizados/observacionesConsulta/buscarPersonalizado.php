...
*/
	...
	if(!isset($_POST['utilizar'])){
	    ...
	    $retorno    = $objetoPersonalizados->buscarPersonalizadoOCConString($stringParaBuscar);
		
	}else{
	    //se busca con el string
	    $retorno    = $objetoPersonalizados->buscarPersonalizadoOCConString($stringParaBuscar, $utilizar);		
	}
