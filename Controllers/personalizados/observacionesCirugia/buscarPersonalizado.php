...
*/
	...
	if(!isset($_POST['utilizar'])){
	    ...
	    $retorno    = $objetoPersonalizados->buscarPersonalizadoOCIConString($stringParaBuscar);
		
	}else{
	    //se busca con el string
	    $retorno    = $objetoPersonalizados->buscarPersonalizadoOCIConString($stringParaBuscar, $utilizar);		
	}
