...
*/
	...
	if(!isset($_POST['utilizar'])){
	    ...
	    $retorno    = $objetoPersonalizados->buscarPersonalizadoOEConString($stringParaBuscar);
		
	}else{
	    //se busca con el string
	    $retorno    = $objetoPersonalizados->buscarPersonalizadoOEConString($stringParaBuscar, $utilizar);		
	}
