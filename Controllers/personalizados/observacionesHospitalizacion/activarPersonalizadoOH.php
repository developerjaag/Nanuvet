...
/*
 * Controlador para activar un personalizado observaciones Hospitalizacion
 */
  ...
  $idPersonalizado = $_POST['idPersonalizado'];
	...
	$objetoPersonalizados->activarPersonalizadoObservacionesHospitalizacion($idPersonalizado); 
