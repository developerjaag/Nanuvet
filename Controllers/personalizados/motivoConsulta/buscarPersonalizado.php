...
*/
	...
	if(!isset($_POST['utilizar'])){
	    ...
	    $retorno    = $objetoPersonalizados->buscarPersonalizadoMCConString($stringParaBuscar);
		
	}else{
	    //se busca con el string
	    $retorno    = $objetoPersonalizados->buscarPersonalizadoMCConString($stringParaBuscar, $utilizar);		
	}
