...
*/
	...
	if(!isset($_POST['utilizar'])){
	    ...
	    $retorno    = $objetoPersonalizados->buscarPersonalizadoOEFConString($stringParaBuscar);
		
	}else{
	    //se busca con el string
	    $retorno    = $objetoPersonalizados->buscarPersonalizadoOEFConString($stringParaBuscar, $utilizar);		
	}
