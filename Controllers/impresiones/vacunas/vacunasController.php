 ...
 */
 ...
 //se consulta la información de la vacuna
 require_once("Models/vacunas_model.php");
 
 $objetoVacunas	= new vacunas(); 
 $datosVacuna	= $objetoVacunas->listarUnaVacunaPaciente($idVacuna);
 ...
 $datosPropietarioPaciente = $objetoPropietarioPaciente->consultarDatosPropietarioPaciente($datosVacuna[0]['idMascota']);
...
$pdf->SetTitle('NanuVet::Vacuna '.$idVacuna);
...
<h1 style="text-align:center;"><u>Vacuna</u></h1>
...
$pdf->Output('NanuVet vacuna '.$idVacuna.'.pdf', 'I');
