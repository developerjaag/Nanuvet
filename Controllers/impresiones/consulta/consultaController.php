 ...
 */
 ...
 $datosConsulta	= $objetoConsulta->listarUnaConsulta($idConsulta);
 ...
 $datosPropietarioPaciente = $objetoPropietarioPaciente->consultarDatosPropietarioPaciente($datosConsulta[0]['idMascota']);
...
$pdf->SetTitle('NanuVet::Consulta '.$idConsulta);
...
<h1 style="text-align:center;"><u>Consulta</u></h1>
...
$html	.='
	...
	<br/>
	<h3>Observaciones exámen fisico</h3>
	<div>
...
$html	.='<br><br/>	<div style="text-align: right; margin-bottom: 1px; position: relative; bottom: 0;">
				...
				<span>-----------------------------------</span>
					<br/>
				<span>'.$datosConsulta[0]['nombreUsuario'].' '.$datosConsulta[0]['apellido'].'&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
$pdf->Output('NanuVet consulta '.$idConsulta.'.pdf', 'I');
