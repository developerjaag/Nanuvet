 ...
 */
 ...
 $datosFormula	= $objetoFormulas->listarUnaFormula($idFormula);
 ...
 $datosPropietarioPaciente = $objetoPropietarioPaciente->consultarDatosPropietarioPaciente($datosFormula[0]['idMascota']);
...
$pdf->SetTitle('NanuVet::Formula '.$idFormula);
...
<h1 style="text-align:center;"><u>Formulación</u></h1>
...
$html	.='<br><br/>	<div style="text-align: right; margin-bottom: 1px; position: relative; bottom: 0;">
				...
				<span>-----------------------------------</span>
					<br/>
				<span>'.$datosFormula[0]['nombreUsuario'].' '.$datosFormula[0]['apellido'].'&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
$pdf->Output('NanuVet formula '.$idFormula.'.pdf', 'I');
