...
/*
 * Controlador para la impresion de un desparasitante
 */
 ...
 //se consulta la información del desparasitante
 require_once("Models/desparasitantes_model.php");
 
 $objetoDesparasitantes	= new desparasitantes(); 
 $datosDesparasitante	= $objetoDesparasitantes->listarUnDesparasitantesPaciente($idDesparasitante);
 ...
 $datosPropietarioPaciente = $objetoPropietarioPaciente->consultarDatosPropietarioPaciente($datosDesparasitante[0]['idMascota']);
...
$pdf->SetTitle('NanuVet::Desparasitante '.$idDesparasitante);
...
<h1 style="text-align:center;"><u>Desparasitante</u></h1>
