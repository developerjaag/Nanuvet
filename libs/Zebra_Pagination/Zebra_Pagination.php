...
class Zebra_Pagination
{
    ...
    private $_properties = array(
        ...
        'next'                      =>  '<span aria-hidden="true"><i class="material-icons">chevron_right</i></span>',
        ...
        'previous'                  =>  '<span aria-hidden="true"><i class="material-icons">chevron_left</i></span>',
    ...
    public function render($return_output = false)
    {
        ...
        $output = '<div class="container white" style="text-align:center;" ><ul class="pagination">';
    ...
    private function _show_pages()
    {
        ...
        // if the total number of pages is greater than the number of selectable pages
            ...
            $output .= '<li class="waves-effect" ><a href="' . $this->_build_uri($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) . '" ' .
